...
# Form implementation generated from reading ui file 'twopage.ui'
#
...
"}")
        ...
        self.page_vision.setStyleSheet("background-color: rgb(86, 88, 93);\n"
"")
        ...
        self.label.setGeometry(QtCore.QRect(650, 0, 640, 480))
        ...
        self.page_data.setStyleSheet("background-color: rgb(86, 88, 93);\n"
"")
        ...
        brush = QtGui.QBrush(QtGui.QColor(86, 88, 93))
        brush.setStyle(QtCore.Qt.SolidPattern)
...
"")
        ...
        self.lcdNumber.setStyleSheet("background-color: rgb(63, 63, 63);")
        ...
        self.lcdNumber_2.setGeometry(QtCore.QRect(20, 180, 91, 50))
        self.lcdNumber_2.setStyleSheet("background-color: rgb(63, 63, 63);")
        self.lcdNumber_2.setSegmentStyle(QtWidgets.QLCDNumber.Outline)
        self.lcdNumber_2.setObjectName("lcdNumber_2")
        self.lcdNumber_3 = QtWidgets.QLCDNumber(self.frame_8)
        self.lcdNumber_3.setGeometry(QtCore.QRect(20, 340, 91, 50))
        self.lcdNumber_3.setStyleSheet("background-color: rgb(63, 63, 63);")
        self.lcdNumber_3.setSegmentStyle(QtWidgets.QLCDNumber.Outline)
        self.lcdNumber_3.setObjectName("lcdNumber_3")
        self.label_5 = QtWidgets.QLabel(self.frame_8)
        self.label_5.setGeometry(QtCore.QRect(120, 190, 81, 21))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.label_8.setStyleSheet("font: 13pt \"Consolas\";")
        self.label_8.setObjectName("label_8")
        self.label_6 = QtWidgets.QLabel(self.page_data)
        self.label_6.setGeometry(QtCore.QRect(50, 200, 361, 41))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Student Engagement Detecting System"))
